...
export class AddPhotoComponent {
  ...
  constructor(private http:Http,private httpClient:HttpClient ,private uoploadPhotoService: UploadPhotoService, private addPhotoService: AddPhotoService, private usrService: UserService) { }
